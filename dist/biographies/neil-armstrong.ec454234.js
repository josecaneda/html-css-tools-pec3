...
window.onload = function() {
    ...
    if (bioAlanLBean = document.getElementById('biography-alan-l-bean')) bioAlanLBean.innerHTML = biographyTextAlanBean;
    if (bioAlanShepard = document.getElementById('biography-alan-shepard')) bioAlanShepard.innerHTML = biographyTextAlanShepard;
};

//# sourceMappingURL=neil-armstrong.ec454234.js.map
